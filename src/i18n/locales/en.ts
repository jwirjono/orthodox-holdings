export const en = {
  ...
  taxCalculator: {
    ...
    corporate: {
      ...
      tierNoteTitle: 'Corporate Income Tax Rates (PPh Badan, Pasal 31E):',
      tierNoteLines: [
        'Revenue up to Rp 4.8 B — 11% × net profit.',
      ...
      standardRateTax: 'Tax at 22%:',
      standardTax: 'Estimated Corporate Income Tax:',
