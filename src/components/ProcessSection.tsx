    ...
    <section id="process" className="py-24 bg-[#080808] text-white border-b border-neutral-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {t.process.steps.map((step) => (
            ...
            >
              ...
              <div className="mt-8 pt-4 border-t border-neutral-800 text-[10px] font-mono uppercase tracking-widest text-neutral-500">
                {format(t.process.phaseLabel, { number: step.number })}
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-16 bg-neutral-900 border border-neutral-800 p-8 rounded-xs flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <button
            onClick={() => onOpenConsultation(t.process.ctaMessage)}
          ...
          >
            <span>{t.common.startConsultation}</span>
